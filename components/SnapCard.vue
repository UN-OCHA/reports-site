  ...
  export default {
    ...
    computed: {
      snapRequest() {
        ...
        return `${this.snapEndpoint}?url=${encodeURIComponent(this.sitRepUrl)}&output=png&width=${windowWidth}&height=${window.innerHeight}&selector=${encodeURIComponent(this.selector)}&cookies=${encodeURIComponent(cookies)}`;
      },
