...
// Noto Sans Myanmar
// @see https://www.google.com/get/noto/#sans-mymr
@font-face {
  font-display: swap;
  font-family: 'Myanmar';
  font-style: normal;
  font-weight: 400;
  src: local('NotoSansMyanmar Light'),
       local('NotoSansMyanmar-Light'),
       url('/fonts/NotoSansMyanmar-Light.ttf') format('woff');
}
@font-face {
  font-display: swap;
  font-family: 'Myanmar';
  ...
  src: local('NotoSansMyanmar Bold'),
       local('NotoSansMyanmar-Bold'),
       url('/fonts/NotoSansMyanmar-Bold.ttf') format('woff');
}
@font-face {
  font-display: swap;
  font-family: 'Myanmar ExtraCondensed';
  font-style: normal;
  font-weight: 400;
  src: local('NotoSansMyanmar ExtraCondensed'),
       local('NotoSansMyanmar-ExtraCondensed'),
       url('/fonts/NotoSansMyanmar-ExtraCondensed.ttf') format('woff');
}
