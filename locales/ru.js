export default {
  ...
  'The URL you requested exists, but there were problems displaying the page.': 'Запрошенный вами URL существует, но при отображении страницы возникли проблемы.',
  ...
  'No funding data available.': 'Данные о финансировании отсутствуют.',
  ...
  // Videos
  'Video': 'Видео',
  'View this Video': 'Просмотреть видео',

  // Interactives
  'Interactive': 'Интерактивная версия',
  'View this interactive graphic': 'Просмотреть интерактивную графику',
  ...
  '# week ago': '# неделя назад',
  '# weeks ago': '# недели/недель назад',
  '# month ago': '# месяц назад',
  '# months ago': '# месяца/месяцев назад',
  '# year ago': '# год назад',
  '# years ago': '# года/лет назад',
