export default {
  ...
  'See entire digital situation report': 'Подивитися Оперативне зведення повністю',
  ...
  '# weeks ago': '# тижні/тижнів тому',
  '# month ago': '# місяць тому',
  '# months ago': '# місяці/місяців тому',
  '# year ago': '# рік тому',
  '# years ago': '# роки/років тому',
