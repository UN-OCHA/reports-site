  ...
  export default {
    ...
    asyncData({env, params, store, error, req, res}) {
      return Promise.all([
        ...
        // FTS: fetch all v2 plans for 2020.
        (process.server)
          ? axios({
              url: 'https://reports.unocha.org/v2/fts/flow/plan/overview/progress/2020',
              method: 'GET',
            })
            .then(response => response.data)
            .catch(console.warn)
          : axios({
              url: '/v2/fts/flow/plan/overview/progress/2020',
              method: 'GET',
            })
            .then(response => response.data)
            .catch(console.warn),
      ...
      ]).then(([entries, translationEntries, flashUpdatesAll, ftsData2019, ftsData2020, ftsData2021, ftsData2022]) => {
        //
        // Check for 404
        //
